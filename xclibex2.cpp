/*
 *
 *	xclibex2.cpp	External	23-Nov-2018
 *
 ...
 *
 *	    cl -I "\Program Files\EPIX\XCLIB\INC" -c xclibex2.cpp
 ...
 *		link xclibex2.obj "\Program Files\EPIX\XCLIB\LIB\XCLIBWNT.LIB" tt.res @t1 @t2
 *	    or	(XCLIB+PXIPL for Windows NT/2000/XP/Vista/7/8/10 32-Bit)
 *		link xclibex2.obj "\Program Files\EPIX\XCLIB\LIB\XCLIBWNT.LIB" "\Program Files\EPIX\XCLIB\LIB\PXIPLWNT.LIB" tt.res @t1 @t2
 *	    or (XCLIB-Lite for Windows NT/2000/XP/Vista/7/8/10 32-Bit)
 *		link xclibex2.obj "\Program Files\EPIX\XCLIB\LIB\XCLYBWNT.LIB" tt.res @t1 @t2
 *
 *	    del t1
 *	    del t2
 *	    del tt.res
 ...
 *	    link xclibex2.obj "\Program Files\EPIX\XCLIB\LIB\XCLIBW64.LIB" tt.res @t1 @t2
 *	or  (XCLIB+PXIPL for Windows XP/Vista/7/8/10 64-Bit
 *	    link xclibex2.obj "\Program Files\EPIX\XCLIB\LIB\XCLIBW64.LIB" "\Program Files\EPIX\XCLIB\LIB\PXIPLW64.LIB" tt.res @t1 @t2
 *
 *	    del t1
 *	    del t2
 *	    del tt.res
 ...
 *
 *  4c) Compile with Microsoft Visual C/C++ V6.0 for Windows NT/2000/XP/Vista/7/8/10 32-Bit as:
 *
 *	    cl -I "\Program Files\EPIX\XCLIB\INC" -c xclibex2.cpp
 *	    rc.exe /l 0x409 /fo tt.res	xclibex2.rc
 *	    echo -subsystem:windows,4.0 -entry:WinMainCRTStartup comdlg32.lib ole32.lib >t1
 ...
 *	    link xclibex2.obj "\Program Files\EPIX\XCLIB\LIB\XCLYBWNT.LIB" tt.res @t1 @t2
 *
 *  4d) Compile with Microsoft Visual C/C++ VS2005 for Windows NT/2000/XP/Vista/7/8/10 32-Bit as:
 *
 *	    cl -I "\Program Files\EPIX\XCLIB\INC" -c xclibex2.cpp
 *	    rc.exe /l 0x409 /fo tt.res	xclibex2.rc
 *	    echo -subsystem:windows,4.0 -entry:WinMainCRTStartup comdlg32.lib ole32.lib >t1
 ...
 *	    link xclibex2.obj "\Program Files\EPIX\XCLIB\LIB\XCLYBWNT.LIB" tt.res @t1 @t2
 *
 *  4e) Compile with Microsoft Visual Studio .NET 2003 command line tools for Windows NT/2000/XP/Vista/7/8/10 32-Bit as:
 *
 ...
 *	    del xclibex2.obj
 *
 *	Or use the IDE, compiling xclibex2.cpp as a Windows NT/2000/XP/Vista/7/8/10 32-Bit app,
 *	using the XCLIBEX2.RC resource, linking to library(s):
 *	    for XCLIB:	      XCLIBWNT.LIB
 *	    for XCLIB+PXIPL:  XCLIBWNT.LIB PXIPLWNT.LIB
 ...
 *	    10. Under C/C++-> General-> Additional Include Directories specify '\Program Files\EPIX\XCLIB\INC'.
 *	    11. Under C/C++-> Precompiled Headers-> Create/Use Precompiled Header
 *		select 'Not Using Precompiled Headers'.
 *	    12. Under Linker-> General-> Additional Include Directories specify '\Program Files\EPIX\XCLIB\INC'.
 ...
 *
 *  4f) Compile with Microsoft Visual Studio 2005 command line tools for Windows NT/2000/XP/Vista/7/8/10 32-Bit as:
 *
 ...
 *	    11. Under 'Configuration Properties', 'General' select 'Character Set' and specify 'Not Set'.
 *	    12. Under C/C++-> General select 'Additional Include Directories' and specify '\Program Files\EPIX\XCLIB\INC'.
 *	    13. Under Resources->General select Additional Include Directories specify '\Program Files\EPIX\XCLIB\INC'.
 *	    14. Under C/C++-> Precompiled Headers select 'Create/Use Precompiled Header' and
 *		  specify 'Not Using Precompiled Headers'.
 *	    15. Under Linker-> General select 'Additional Include Directories' and specify '\Program Files\EPIX\XCLIB\INC'.
 ...
 *
 *  4g) Compile with Microsoft Visual C/C++ Vx.x for Windows XP/Vista/7/8/10 64-Bit):
 *
 *	    cl -I "\Program Files\EPIX\XCLIB\INC" -c xclibex2.cpp
 *	    rc.exe /l 0x409 /fo tt.res xclibex2.rc
 *	    echo -subsystem:windows -machine:X64 -entry:WinMainCRTStartup comdlg32.lib ole32.lib >t1
 ...
 *
 *  4i) Compile with Borland C++ V5.0 for Windows NT/2000/XP/Vista/7/8/10 32-Bit:  same as for
